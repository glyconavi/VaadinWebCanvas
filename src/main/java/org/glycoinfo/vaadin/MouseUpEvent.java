...
public class MouseUpEvent<C extends Component> extends ComponentEvent<C> {
    /**
     * 
     */
    ...
    public MouseUpEvent(Component source, boolean fromClient,
     ...
     * @param source
     */
    public MouseUpEvent(Component source) {
