...
public class MouseDownEvent<C extends Component> extends ComponentEvent<C> {
    /**
     * 
     */
    ...
    public MouseDownEvent(Component source, boolean fromClient,
     ...
     * @param source
     */
    public MouseDownEvent(Component source) {
